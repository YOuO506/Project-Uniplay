...
namespace Game_Puzzle
{
    public class Dongle : MonoBehaviour
    {
        ...
        IEnumerator HideRoutine(Vector3 targetPos)
        {
            ...
            manager.score += (int)Mathf.Pow(2f, level);

            // 코인 획득 : level * 1
            manager.currentCoin += (level * 1);

            // UI 갱신 : GetCoin 텍스트 업데이트
            manager.getCoinText.text = $"+{manager.currentCoin}";
        ...
        IEnumerator LevelUpRoutine()
        {
            ...
            EffectPlay();
            manager.SfxPlayer(GameManager.Sfx.LevelUp);
